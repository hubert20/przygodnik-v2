...
|------|---------|-------------|
| [PATTERNS.md](references/PATTERNS.md) | Reusable patterns | Implementation |
| [ADVANCED.md](references/ADVANCED.md) | Complex scenarios | Edge cases |
```
...
> For more on these patterns, see [Architecture Patterns](references/PATTERNS.md)
```

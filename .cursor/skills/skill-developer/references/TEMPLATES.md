...
> For detailed examples and edge cases, see [CONCEPT_ONE.md](references/CONCEPT_ONE.md)

### Concept 2

[Summary in 2-3 paragraphs max]

> For detailed examples and edge cases, see [CONCEPT_TWO.md](references/CONCEPT_TWO.md)
...
> For more troubleshooting, see [TROUBLESHOOTING.md](references/TROUBLESHOOTING.md)

## Resource Files

| File | Content | When to Use |
|------|---------|-------------|
| [CONCEPT_ONE.md](references/CONCEPT_ONE.md) | Detailed coverage of concept 1 | Deep dive needed |
| [CONCEPT_TWO.md](references/CONCEPT_TWO.md) | Detailed coverage of concept 2 | Deep dive needed |
| [TROUBLESHOOTING.md](references/TROUBLESHOOTING.md) | Extended problem-solving | Debugging |
```
...
**Note:** In Cursor, skills don't require `skill-rules.json` - they are automatically discovered from `.cursor/skills/`. The agent decides when to apply them based on context.

For reference, in Claude Code you would add to `.claude/skills/skill-rules.json`:
...
Use for resource files in the `references/` directory:
...
**Note:** Cursor doesn't support slash commands like Claude Code. Skills are automatically applied or can be referenced explicitly in prompts.

For reference, in Claude Code you would create in `.claude/commands/`:

```markdown
Activate the [skill-name] skill to help with [task].

Read the skill file at `.cursor/skills/[skill-name]/SKILL.md` and apply its guidance.
...
- `.cursor/skills/[skill-name]/references/[RESOURCE1].md`
- `.cursor/skills/[skill-name]/references/[RESOURCE2].md`
```

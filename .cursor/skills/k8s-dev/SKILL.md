...
> **Detailed Standards:** Create project-specific K8s operations doc (e.g., `docs/K8S_OPERATIONS.md`) if needed
...
|------|---------|-------------|
| [MANIFEST_TEMPLATES.md](references/MANIFEST_TEMPLATES.md) | Complete manifest examples | Creating new deployments |
| [LABEL_STANDARDS.md](references/LABEL_STANDARDS.md) | Label conventions | Reviewing/creating resources |
| [COMMON_ISSUES.md](references/COMMON_ISSUES.md) | Troubleshooting guide | Debugging problems |

---

## Usage

This skill automatically activates when working with Kubernetes manifests or K8s-related code. The agent applies these guidelines based on context.

You can also reference it explicitly:
- "Use k8s-dev patterns for this deployment"
- "Follow k8s-dev labeling standards"
- "Apply k8s-dev resource limits"
